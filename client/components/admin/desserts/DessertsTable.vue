    ...
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr v-else-if="filteredDesserts.length === 0">
            <td colspan="7" class="px-6 py-4 text-center text-gray-500">
              No se encontraron postres
            </td>
          </tr>
          <tr v-for="dessert in filteredDesserts" :key="dessert._id" class="hover:bg-gray-50">
...
// Nuevo: Computed para filtrar localmente
const filteredDesserts = computed(() => {
  if (!selectedType.value) return dessertsStore.desserts;
  return dessertsStore.desserts.filter(d => d.type === selectedType.value);
});
